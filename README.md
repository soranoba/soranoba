...
- [bxcodec/faker](https://github.com/bxcodec/faker) ([v4.0.0-beta.2](https://github.com/bxcodec/faker/releases/tag/v4.0.0-beta.2), 3 weeks ago) - Go (Golang)  Fake Data  Generator for Struct. [Notes]This repository is archived, moved to the new repository https://github.com/go-faker/faker
