...
- [bxcodec/faker](https://github.com/bxcodec/faker) ([v4.0.0-beta.3](https://github.com/bxcodec/faker/releases/tag/v4.0.0-beta.3), 4 weeks ago) - Go (Golang)  Fake Data  Generator for Struct. [Notes]This repository is archived, moved to the new repository https://github.com/go-faker/faker
