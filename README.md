...
- [bxcodec/faker](https://github.com/bxcodec/faker) ([v4.0.0-beta.2](https://github.com/bxcodec/faker/releases/tag/v4.0.0-beta.2), 4 days ago) - Go (Golang)  Fake Data  Generator for Struct. [Notes]This repository is archived, moved to the new repository https://github.com/go-faker/faker
